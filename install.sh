...
ensure_config_key "DIFY_RAG_GATEWAY_PATH_PREFIX" "$CONFIG_FILE"
...
ensure_config_key "DIFY_RAG_REMOTE_PUBLIC_URL" "$CONFIG_FILE"
ensure_config_key "DIFY_RAG_AUTH_PROVIDER" "$CONFIG_FILE"
ensure_config_key "DIFY_RAG_OAUTH_AUTHORIZATION_SERVER" "$CONFIG_FILE"
ensure_config_key "DIFY_RAG_OAUTH_SCOPES" "$CONFIG_FILE"
ensure_config_key "DIFY_RAG_AUTH_ALLOWED_EMAILS" "$CONFIG_FILE"
ensure_config_key "DIFY_RAG_AUTH_ALLOWED_DOMAINS" "$CONFIG_FILE"
ensure_config_key "DIFY_RAG_AUTH_ALLOW_ALL" "$CONFIG_FILE"
...
if [ -z "$CURRENT_GATEWAY_URL" ]; then
    ...
    echo "Example: https://api.example.com/rag"
